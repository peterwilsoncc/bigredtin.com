...
rel='next' title='Forms are forms, not lists' href='/behind-the-websites/forms-are-forms-not-lists/' /><link
...
href="/behind-the-websites/forms-are-forms-not-lists/" rel="next">Forms are forms, not lists</a></div></div><div
...
rel="nofollow" id="cancel-comment-reply-link" href="/design/poka-yoke-ux-design/#respond" style="display:none;">Click here to cancel reply.</a></div><div
...
for="s-622692" class="search-label">Search this Site</label> <input
type="text" name="s" id="s-622692" class="searchInput inputText" /> <input
...
Database Caching 37/54 queries in 0.008 seconds using apc
Content Delivery Network via sg.assets.sgiant.com/pressgiant

Served from: bigredtin.com @ 2011-01-01 17:37:59 -->