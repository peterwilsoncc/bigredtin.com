...
http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title> JavaScript Localisation in WordPress  |  Big Red Tin</title><link
...
rel="pingback" href="/xmlrpc.php" /> <script type="text/javascript">var _gaq=_gaq||[];_gaq.push(['_setAccount','UA-11132236-2']);_gaq.push(['_setAllowAnchor',true],['_setCustomVar',1,'author','peter-wilson',3],['_setCustomVar',2,'tags','coding javascript themes wordpress wp_enqueue_script wp_loca',3],['_setCustomVar',3,'year','2010',3],['_trackPageview']);(function(){var ga=document.createElement('script');ga.type='text/javascript';ga.async=true;ga.src=('https:'==document.location.protocol?'https://ssl':'http://www')+'.google-analytics.com/ga.js';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(ga,s);})();</script> <link
rel="alternate" type="application/rss+xml" title="Big Red Tin &raquo; JavaScript Localisation in WordPress Comments Feed" href="/behind-the-websites/javascript-localisation-in-wordpress/feed/" /><link
...
rel='prev' title='Delay Print Stylesheets Plugin' href='/behind-the-websites/delay-print-css-plugin/' /><link
rel='next' title='HTML5 for Web Designers' href='/behind-the-websites/html5-for-web-designers-9/' /><link
rel='shortlink' href='/?p=759' /><meta
name="description" content="I was asked on Twitter recently if it's possible to pass WordPress data to JavaScript, wp_localize_script() is the tool to do it with." /><meta
name="keywords" content="coding,javascript,themes,wordpress,wp_enqueue_script,wp_localize_script" /><link
rel="canonical" href="/behind-the-websites/javascript-localisation-in-wordpress/" />  <script type="text/javascript">var _wpcf7={cached:1};</script> <link
...
id="brt" class="nojs nojswin bxSngl bxAllBlog bxPost bxP-javascript-localisation-in-wordpress bxP-id759 bxPC-behind-the-websites bxPTag-coding bxPTag-javascript bxPTag-themes bxPTag-wordpress bxPTag-wp_enqueue_script bxPTag-wp_localize_script bxPA-peter"><div
...
id="content"><div
id="contentHeadA" class="hentry p1 post publish post-javascript-localisation-in-wordpress author-peter-wilson cat-behind-the-websites tagged tag-coding tag-javascript tag-themes tag-wordpress tag-wp_enqueue_script tag-wp_localize_script"><div
id="contentHead"><h1 class="entry-title" id="pageName"> <a
href="/behind-the-websites/javascript-localisation-in-wordpress/" title="JavaScript Localisation in WordPress" rel="bookmark"> JavaScript Localisation in WordPress </a></h1><p
class="entry-date"><span
class="published" title="2010-09-02T06:00:45+00:00">2 Sep '10</span></p></div><div
id="contentA"><div
class="entry-meta"><p
class="details"> <span
...
href="/behind-the-websites/javascript-localisation-in-wordpress/#comments">2 responses</a></p></div><div
class="entry-content"><p>Recently on Twitter <a
title="@iamcracks" href="http://twitter.com/iamcracks/" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','twitter.com/iamcracks/']);">@iamcracks</a> asked</p><blockquote><p>Attention WordPress Wizards &amp; Gurus. Is it possible to &#8220;get WordPress to write a custom field into a javascript variable&#8221;?</p><p>&#8211; <a
title="source" href="http://twitter.com/iamcracks/status/22658211370" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','twitter.com/iamcracks/status/22658211370']);">source</a></p></blockquote><p>While I wouldn&#8217;t be so bold as to claim I&#8217;m either a wizard or a guru, I happen to know the answer to @iamcracks question.</p><p>A while back I wrote a two part tutorial on using <a
...
/* ]]&gt; */
&lt;/script&gt;
&lt;script type='text/javascript' src='/path/2/script.js?ver=1.0.1'&gt;&lt;/script&gt;</code></pre></div><p
...
href="/tag/wp_enqueue_script/" rel="tag">wp_enqueue_script</a> &bull; <a
href="/tag/wp_localize_script/" rel="tag">wp_localize_script</a></p><div
...
href="/behind-the-websites/delay-print-css-plugin/" rel="prev">Delay Print Stylesheets Plugin</a></div><div
class="page-nav-newer"><span
class="direction">Next post: </span><a
href="/behind-the-websites/html5-for-web-designers-9/" rel="next">HTML5 for Web Designers</a></div></div><div
id="comments"><h2> 2 Comments</h2><ol
id="commentsList" class="commentsList"><li
id="comment-1866" class="comment even thread-even depth-1"><div
class="comment-head"><p
class="comment-author vcard"> <img
alt='' src='http://1.gravatar.com/avatar/9f9b2d5b31622e2cfdc0bc0a0347d99f?s=32&amp;d=http%3A%2F%2Fbigredtin.com%2Fwp-includes%2Fimages%2Fblank.gif&amp;r=G' class='avatar avatar-32 photo' height='32' width='32' /><cite
class="fn">Cracks</cite> <span
class="says">says:</span></p></div><div
class="comment-body" id="c-body-1866"><p>@pwcc &#8230; You SO ARE a Wizard/Guru of sorts. I&#8217;ll probably read this article again, again, and then one more time, before getting @soupgiant to implement it because I cannot.</p><p>Thanks for time.</p></div><div
class="comment-footer" id="c-footer-1866"><p
class="comment-meta"> <a
href="#comment-1866">September 2, 2010 at 10:46 am</a></p></div><ul
class='children'><li
id="comment-1867" class="comment byuser comment-author-peter bypostauthor odd alt depth-2"><div
class="comment-head"><p
class="comment-author vcard"> <img
...
class="says">says:</span></p></div><div
class="comment-body" id="c-body-1867"><p>Thanks, you&#8217;re very kind and of course we can help.</p></div><div
class="comment-footer" id="c-footer-1867"><p
class="comment-meta"> <a
href="#comment-1867">September 2, 2010 at 10:52 am</a></p></div></li></ul></li></ol><div
...
rel="nofollow" id="cancel-comment-reply-link" href="/behind-the-websites/javascript-localisation-in-wordpress/comment-page-1/#respond" style="display:none;">Click here to cancel reply.</a></div><div
...
type='hidden' name='comment_post_ID' value='759' id='comment_post_ID' /> <input
...
for="s-295181" class="search-label">Search this Site</label> <input
type="text" name="s" id="s-295181" class="searchInput inputText" /> <input
