...
http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title> Delay Print Stylesheets Plugin  |  Big Red Tin</title><link
...
rel="pingback" href="/xmlrpc.php" /> <script type="text/javascript">var _gaq=_gaq||[];_gaq.push(['_setAccount','UA-11132236-2']);_gaq.push(['_setAllowAnchor',true],['_setCustomVar',1,'author','peter-wilson',3],['_setCustomVar',2,'tags','css javascript plugin wordpress',3],['_setCustomVar',3,'year','2010',3],['_trackPageview']);(function(){var ga=document.createElement('script');ga.type='text/javascript';ga.async=true;ga.src=('https:'==document.location.protocol?'https://ssl':'http://www')+'.google-analytics.com/ga.js';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(ga,s);})();</script> <link
rel="alternate" type="application/rss+xml" title="Big Red Tin &raquo; Delay Print Stylesheets Plugin Comments Feed" href="/behind-the-websites/delay-print-css-plugin/feed/" /><link
...
rel='prev' title='An Answer to the Twitter Question' href='/business/an-answer-to-the-twitter-question/' /><link
rel='next' title='JavaScript Localisation in WordPress' href='/behind-the-websites/javascript-localisation-in-wordpress/' /><link
rel='shortlink' href='/?p=739' /><meta
name="description" content="A few weeks ago I wrote a post in which I adapted an idea from a zOompf article to delay the loading of print stylesheets until after a web page has fully rendered. I've decided to convert the code from the original post into a plugin and add it to the WordPress plugin directory." /><meta
name="keywords" content="css,javascript,plugin,wordpress" /><link
rel="canonical" href="/behind-the-websites/delay-print-css-plugin/" />  <script type="text/javascript">var _wpcf7={cached:1};</script> <link
...
id="brt" class="nojs nojswin bxSngl bxAllBlog bxPost bxP-delay-print-css-plugin bxP-id739 bxPC-behind-the-websites bxPTag-css bxPTag-javascript bxPTag-plugin bxPTag-wordpress bxPA-peter"><div
...
id="content"><div
id="contentHeadA" class="hentry p1 post publish post-delay-print-css-plugin author-peter-wilson cat-behind-the-websites tagged tag-css tag-javascript tag-plugin tag-wordpress"><div
id="contentHead"><h1 class="entry-title" id="pageName"> <a
href="/behind-the-websites/delay-print-css-plugin/" title="Delay Print Stylesheets Plugin" rel="bookmark"> Delay Print Stylesheets Plugin </a></h1><p
class="entry-date"><span
class="published" title="2010-08-27T12:17:29+00:00">27 Aug '10</span></p></div><div
id="contentA"><div
class="entry-meta"><p
class="details"> <span
...
href="/behind-the-websites/delay-print-css-plugin/#comments">No responses</a></p></div><div
class="entry-content"><p>A few weeks ago I wrote a post in which I <a
...
title="download" href="http://wordpress.org/extend/plugins/delay-print-css/download/" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','wordpress.org/extend/plugins/delay-print-css/download/']);">download</a> the <a
title="Delay Print CSS Plugin" href="http://http://wordpress.org/extend/plugins/delay-print-css/" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://wordpress.org/extend/plugins/delay-print-css/']);">Delay Print CSS Plugin</a> from the WordPress plugin repository.</p></div><p
...
href="/business/an-answer-to-the-twitter-question/" rel="prev">An Answer to the Twitter Question</a></div><div
class="page-nav-newer"><span
class="direction">Next post: </span><a
href="/behind-the-websites/javascript-localisation-in-wordpress/" rel="next">JavaScript Localisation in WordPress</a></div></div><div
id="comments"><div
id="respond"><h2>Leave a Reply</h2><div
id="cancel-comment-reply"><a
rel="nofollow" id="cancel-comment-reply-link" href="/behind-the-websites/delay-print-css-plugin/#respond" style="display:none;">Click here to cancel reply.</a></div><div
...
type='hidden' name='comment_post_ID' value='739' id='comment_post_ID' /> <input
...
for="s-759647" class="search-label">Search this Site</label> <input
type="text" name="s" id="s-759647" class="searchInput inputText" /> <input
...
Served from: bigredtin.com @ 2011-01-01 17:46:28 -->